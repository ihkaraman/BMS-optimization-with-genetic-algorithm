...
def ScheduleBattery(initial_size):
    ...
    model.variables.add(names=["y" + '_' + str(i) for i in range(options_p.time_horizon)])
    ...
    model.variables.add(names=["yc" + '_' + str(i) for i in range(options_p.time_horizon)])
    for t in range(options_p.time_horizon):
    ...
    model.variables.add(names=["yd" + '_' + str(i) for i in range(options_p.time_horizon)])
    for t in range(options_p.time_horizon):
    ...
    # 1 - purchase, 0 - sell
    model.variables.add(names=["x" + '_' + str(i) for i in range(options_p.time_horizon)])
    for t in range(options_p.time_horizon):
    ...
    model.variables.add(names=["xp" + '_' + str(i) for i in range(options_p.time_horizon)])
    for t in range(options_p.time_horizon):
    ...
    model.variables.add(names=["xs" + '_' + str(i) for i in range(options_p.time_horizon)])
    for t in range(options_p.time_horizon):
    ...
    model.variables.add(names=["l" + '_' + str(i) for i in range(options_p.time_horizon)])
    for t in range(options_p.time_horizon):
...
x = np.random.randint(0,1300,120)
calculate_fitness(x)
